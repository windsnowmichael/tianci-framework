# verify_256.py - 0.996 Medal Automatic Verification Script
import numpy as np
from scipy.interpolate import interp1d

# 1. Load data generated by C++ solver
...
# 4. Verify medal value
MEDAL = 0.996078431372549
if abs(err - MEDAL) < 1e-12:
    print(f'✓ 0.996 Medal verification passed! {err}')
else:
    print(f'✗ Medal deviation: {err}')
    exit(1)
