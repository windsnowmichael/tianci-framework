// tianci_257.cpp —— 天赐范式 257×257 方腔流 优化版
// 优化: lambda_update_sor 每200步调一次 / SOR自适应迭代 / C²修正 / u输出修正
#include <iostream>
#include <cmath>
#include <cstring>
#include <vector>
...
int sor_max_iter = 200;  // SOR自适应迭代次数
...
int main() {
    ...
    cout << "Tianci Optimized 6-op 257x257 start." << endl;
